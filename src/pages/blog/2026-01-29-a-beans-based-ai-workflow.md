...
And taking advantage of that structure in a ralph loop. Learn more about [ralph loops](https://www.humanlayer.dev/blog/brief-history-of-ralph) here. As I've been experimenting, I've noticed additional ways I can modify my loop and make it better.
...
You can check out the repo [here](https://github.com/internet-development/daedalus) and use the agents and skills in your OpenCode or Claude Code.
